...
export const useModal = defineStore("modal", () => {
  ...
  return { open, openMember, openTask, openComment, openEditBoard, openEditTask }
})
...
export const useBoard = defineStore("board", () => {
  ...
  return { boards, tasks, fetchTask, boardId, title, users, user, isOwner, deleteBoard, taskId, boardMembers, selectedTask, selectedBoard, comments, fetchComments }
})